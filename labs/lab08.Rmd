...
ggplot(mpg) + 
  aes(displ) +
  geom_density(fill = "blue", alpha = .2, col = "white") + 
  labs(title = "Engine Displacement Histogram", subtitle = "", x = "Displacement (L)", caption = "Source: EPA 2008 Fuel Economy Dataset")
```
...
ggplot(mpg) + 
  ...
  labs(title = "Engine Displacement Histogram", subtitle = "Colored by Vehicle Class", x = "Displacement (L)", caption = "Source: EPA 2008 Fuel Economy Dataset")
...
```{r}
ggplot() +
  geom_density(aes(mpg$cty), fill = "red", col = "white", alpha = .2) +
  geom_density(aes(mpg$hwy), fill = "blue", col = "white", alpha = .2) +
  xlim(0, 50)
  labs(title = "Engine Displacement Density", subtitle = "Colored by City Fuel Efficiency (Red) and Highway (Blue)", x = "MPG", caption = "Source: EPA 2008 Fuel Economy Dataset")
```
...
ggplot(mpg, aes(x = cty, y = hwy)) + 
  ...
  labs(title = "City vs Highway Fuel Efficiency", subtitle = "With", x = "City MPG", y = "Highway MPG", caption = "Source: EPA 2008 Fuel Economy Dataset")
...
ggplot(mpg, aes(x = cyl, y = cty)) + 
  ...
  geom_smooth(method='lm') +
  geom_boxplot() +
  labs(title = "City Fuel Efficiency by Num Cylinders", subtitle = "With", x = "Ci MPG# Cylinders", y = "City MPG", caption = "Source: EPA 2008 Fuel Economy Dataset")
...
ggplot(mpg, aes(x = class, y = cty)) + 
  geom_violin(fill = "brown", alpha = .4) +
  labs(title = "City Fuel Efficiency by Num Cylinders", subtitle = "With", x = "Ci MPG# Cylinders", y = "City MPG", caption = "Source: EPA 2008 Fuel Economy Dataset")
...
ggplot(Xy, aes(x,y)) + 
  geom_point()+
  stat_function(fun = function(x){y=x^2}, col = "green")
```
...
Write an R function `is_odd` and a C++ funsction `is_odd_cpp` that evaluates if a number is odd and returns true if so.
...
Using `system.tsime', run both functions 1,000,000 times on the numbers 1, 2, ..., 1000000. Who is faster and by how much?
...
n = 1000
p = 20
X = matrix(rnorm(n * p), nrow = 50, ncol = 20)
